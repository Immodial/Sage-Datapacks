...
data modify entity @s Item set value {id:"minecraft:iron_ingot",count:1,components:{"minecraft:item_name":"'Malleable Iron'","minecraft:custom_data":{URMalleable:true},"minecraft:custom_model_data":1,"!minecraft:max_stack_size":{},"minecraft:fire_resistant":{}}}