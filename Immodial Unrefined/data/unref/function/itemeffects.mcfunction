...
execute if items entity @s contents raw_iron[custom_data~{URScrap:true}] if block ~ ~ ~ water run function unref:modify/coolironscrap
execute if items entity @s contents iron_nugget[custom_data~{URMolten:true}] if block ~ ~ ~ water run function unref:modify/coolmoltenironnugget
