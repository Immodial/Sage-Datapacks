...
execute if score _BasePiece WNGlobals matches 1 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell set value [{SpellPiece:"melon"}]
...
execute if score _BasePiece WNGlobals matches 3 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell set value [{SpellPiece:"jungletree"}]
execute store result score _SecondPiece WNGlobals run random value 1..5
execute unless score _BasePiece WNGlobals matches 1 if score _SecondPiece WNGlobals matches 1 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell append value {SpellPiece:"melon"}
...
execute unless score _BasePiece WNGlobals matches 3 if score _SecondPiece WNGlobals matches 3 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell append value {SpellPiece:"jungletree"}
execute unless score _BasePiece WNGlobals matches 4 if score _SecondPiece WNGlobals matches 4 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell append value {SpellPiece:"bamboo"}
execute unless score _BasePiece WNGlobals matches 5 if score _SecondPiece WNGlobals matches 5 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell append value {SpellPiece:"healarea"}
execute store result score _ThirdPiece WNGlobals run random value 1..5
execute unless score _BasePiece WNGlobals matches 1 unless score _SecondPiece WNGlobals matches 1 if score _ThirdPiece WNGlobals matches 1 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell append value {SpellPiece:"melon"}
...
execute unless score _BasePiece WNGlobals matches 3 unless score _SecondPiece WNGlobals matches 3 if score _ThirdPiece WNGlobals matches 3 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell append value {SpellPiece:"jungletree"}
execute unless score _BasePiece WNGlobals matches 4 unless score _SecondPiece WNGlobals matches 4 if score _ThirdPiece WNGlobals matches 4 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell append value {SpellPiece:"bamboo"}
execute unless score _BasePiece WNGlobals matches 5 unless score _SecondPiece WNGlobals matches 5 if score _ThirdPiece WNGlobals matches 5 run data modify entity @e[tag=WNDefiningBook,limit=1] Item.components.minecraft:custom_data.WNCrouchSpell append value {SpellPiece:"healarea"}
