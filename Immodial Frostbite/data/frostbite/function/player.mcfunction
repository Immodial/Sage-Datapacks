...
scoreboard players set @a[scores={FBTemperature=1..,FBBreath=5..}] FBBreath 0
# Apply sweltering
attribute @s[scores={FBTemperature=1800..}] generic.movement_speed modifier add frostbite:heat_slow_minor -0.15 add_multiplied_base
attribute @s[scores={FBTemperature=..1799}] generic.movement_speed modifier remove frostbite:heat_slow_minor
attribute @s[scores={FBTemperature=2200..}] generic.movement_speed modifier add frostbite:heat_slow_major -0.15 add_multiplied_base
attribute @s[scores={FBTemperature=..2199}] generic.movement_speed modifier remove frostbite:heat_slow_major
...
# Apply freezing
attribute @s[scores={FBTemperature=..-1800}] generic.movement_speed modifier add frostbite:cold_slow_minor -0.15 add_multiplied_base
attribute @s[scores={FBTemperature=-1799..}] generic.movement_speed modifier remove frostbite:cold_slow_minor
attribute @s[scores={FBTemperature=..-2200}] generic.movement_speed modifier add frostbite:cold_slow_major -0.15 add_multiplied_base
attribute @s[scores={FBTemperature=-2199..}] generic.movement_speed modifier remove frostbite:cold_slow_major
