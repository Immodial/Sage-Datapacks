...
execute if score @s FBTemperature matches ..-2500 run scoreboard players add @s FBTemperature 1
execute if score @s FBTemperature matches ..-3200 run scoreboard players add @s FBTemperature 1
