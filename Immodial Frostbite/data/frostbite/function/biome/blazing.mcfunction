...
## >> Input: None
execute if score @s FBTemperature matches 3200.. run scoreboard players remove @s FBTemperature 1
execute if score @s FBTemperature matches 2500.. run scoreboard players remove @s FBTemperature 1
