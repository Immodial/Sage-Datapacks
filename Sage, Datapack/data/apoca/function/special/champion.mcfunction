...
attribute @s attack_damage modifier add apoca:champion_attack 0.35 add_multiplied_base
attribute @s armor modifier add apoca:champion_armor_mult 0.5 add_multiplied_total
