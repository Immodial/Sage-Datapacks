## >> From: frostbite:consume/susstew (advancement)
## >> At: Player who ate a sussy stew
## >> As: Player who ate a sussy stew
## >> Does: Reduce temperature
## >> Input: None
# Reset drink
advancement revoke @s only frostbite:consume/susstew
