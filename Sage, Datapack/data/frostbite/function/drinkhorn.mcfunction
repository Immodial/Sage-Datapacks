...
{id:"minecraft:poisonous_potato",components:{"minecraft:item_name":"[{translate:'item.frostbite.drinking_horn'}]","minecraft:item_model":"frostbite:drinking_horn","minecraft:custom_data":{"FBDrinkHorn":true},"minecraft:custom_model_data":{floats:[0]},"minecraft:consumable":{animation:"block",consume_seconds:100000,has_consume_particles:false},"!food":{},"!max_stack_size":{}}}}}}}}}}}]