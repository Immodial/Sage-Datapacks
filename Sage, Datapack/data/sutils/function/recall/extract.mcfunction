## >> From: sutils:recall/load
## >> At: Player loading a recall
## >> As: Player loading a recall
## >> Does: Remove stored items
## >> Input: None
...
item replace entity @s hotbar.0 from block ~ ~1 ~ container.0
item replace entity @s hotbar.1 from block ~ ~1 ~ container.1
item replace entity @s hotbar.2 from block ~ ~1 ~ container.2
item replace entity @s hotbar.3 from block ~ ~1 ~ container.3
item replace entity @s hotbar.4 from block ~ ~1 ~ container.4
item replace entity @s hotbar.5 from block ~ ~1 ~ container.5
item replace entity @s hotbar.6 from block ~ ~1 ~ container.6
item replace entity @s hotbar.7 from block ~ ~1 ~ container.7
item replace entity @s hotbar.8 from block ~ ~1 ~ container.8
...
execute if block ~ ~1 ~ barrel run setblock ~ ~1 ~ air