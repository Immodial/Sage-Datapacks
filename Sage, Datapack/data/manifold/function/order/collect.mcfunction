...
execute unless block ~ ~-1 ~ #replaceable align xyz run summon bat ~0.5 ~-0.5 ~0.5 {Tags:["MNFTarget","APOCCrammingProof","MNFTargetedCollection","MNFTargeting"],PersistenceRequired:true,Health:1f,NoAI:true,Silent:true,active_effects:[{id:"minecraft:invisibility",duration:-1,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:9,show_particles:false}]}
