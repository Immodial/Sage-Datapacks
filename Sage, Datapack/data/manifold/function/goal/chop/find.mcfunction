...
$execute rotated $(Yaw) $(Pitch) if score _FindDistance MNFGlobals matches 1.. if block ~ ~ ~ #replaceable positioned ^ ^ ^0.5 run return run function manifold:goal/chop/find with storage manifold ResourceFinder
