...
execute facing entity @n[type=#illager,tag=!MNFGoaled,distance=..20] eyes rotated ~ 0 run summon bat ^ ^-1.2 ^0.49 {Tags:["MNFTarget","APOCCrammingProof","MNFTargetedDummy","MNFTargeting"],PersistenceRequired:true,Health:1f,NoAI:true,Silent:true,active_effects:[{id:"minecraft:invisibility",duration:-1,show_particles:false},{id:"minecraft:resistance",duration:-1,amplifier:9,show_particles:false}]}
