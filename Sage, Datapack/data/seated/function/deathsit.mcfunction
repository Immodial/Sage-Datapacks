...
execute unless data entity @s respawn run return run tag @e[type=item_display] remove STDSeating
execute store result entity @n[tag=STDSeating] Pos[0] double 1 run data get entity @s respawn.pos[0]
execute store result entity @n[tag=STDSeating] Pos[1] double 1 run data get entity @s respawn.pos[1]
execute store result entity @n[tag=STDSeating] Pos[2] double 1 run data get entity @s respawn.pos[2]
