...
execute if data storage windings {parse:{Deciphering:"emealt"}} run data modify storage windings parse.New set value "A<Y"
...
execute if data storage windings {parse:{Deciphering:"amealt"}} run data modify storage windings parse.New set value "D <Y"
