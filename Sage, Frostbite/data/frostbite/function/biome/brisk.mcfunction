...
## >> Input: None
execute if score @s FBTemperature matches -200.. run scoreboard players remove @s FBTemperature 1
execute if score @s FBTemperature matches -1200.. run scoreboard players remove @s FBTemperature 1
